...
function setup() {
  ...
  pendulum1 = new Pendulum(340, 450,50,50);
  pendulum2 = new Pendulum(400, 450, 50,50);
  pendulum3 = new Pendulum(460, 450,50,50);
  pendulum4 = new Pendulum(520, 450,50,50);
  pendulum5 = new Pendulum(580, 450,50,50);
  roof=new Roof(460,200,300,50)
